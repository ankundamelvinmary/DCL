...
import com.example.diabetesmanagement.Adapters.PhysiothelapistsAdapter;
import com.example.diabetesmanagement.Models.PhysiothelapistsModel;
...
public class Getphysiothelapist extends AppCompatActivity {
    private static final String PHYSIOTHELAPISTS_LIST_URL = "http://192.168.1.103/dcl/getphysiothelapists.php";
